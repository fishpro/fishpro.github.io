---
layout: post
title: Spring Boot Security JWT 整合实现前后端分离认证示例
categories: SpringBoot
description: Spring Boot Security JWT 整合实现前后端分离认证示例
keywords: Security,JWT,SpringBoot
---
...
- **JWT 认证逻辑是什么？**
  ...
  **图1**
  ![Json Web Token 登录验证与授权验证流程](https://www.cnblogs.com/images/cnblogs_com/fishpro/1453719/o_jwt2.jpg)
...
**图2**
![JWT 用户登录获取Token详细页面流程图](https://www.cnblogs.com/images/cnblogs_com/fishpro/1453719/o_jwt3.jpg)

**图3**
![JWT 请求授权页面流程](https://www.cnblogs.com/images/cnblogs_com/fishpro/1453719/o_jwt4.jpg)

[本项目源码下载](https://github.com/fishpro/spring-boot-study/tree/master/spring-boot-study-securityjwt)
